...
enum {
    ...
    TILE_FRAME_TOP_LEFT, TILE_FRAME_TOP_MID, TILE_FRAME_TOP_RIGHT,
    TILE_FRAME_BOT_LEFT, TILE_FRAME_BOT_MID, TILE_FRAME_BOT_RIGHT,
    TILE_FRAME_SIDE_LEFT, TILE_FRAME_SIDE_RIGHT,
};

struct tilecoords { unsigned char x0, y0, x1, y1, x2, y2, x3, y3; };

struct tilecoords tilemap_get_tilecoords(int tile);
...
/*   tile coordinates         {  x0, y0,  x1, y1,  x2,  y2,  x3,  y3 } */
    ...
    [TILE_NUM_2]            = {  32, 96,  45, 96,  32, 119,  45, 119 },
    ...
    [TILE_FRAME_SIDE_LEFT]  = {   2, 40,  12, 40,   2,  72,  12,  72 },
    [TILE_FRAME_SIDE_RIGHT] = {  32, 40,  42, 40,  32,  72,  42,  72 },
};

struct tilecoords
tilemap_get_tilecoords(int tile)
{
